...
export const artists: Artist[] = [
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "E Pluribus Unum (Proposed Sculpture). In 2011, Wilson proposed a sculpture for the Indianapolis Cultural Trail that re-imagined the \"Soldiers and Sailors Monument.\" He planned to isolate the figure of the nameless freed slave (who sits passively at the base of the real monument) and elevate him to a heroic status, holding a flag of many African nations. The project sparked fierce local debate; critics felt it merely reproduced a subservient image of Blackness rather than empowering it. Influence & Existence: The project was ultimately canceled due to the public outcry—a rare example where the absence of the art became the activism. The controversy forced the city to have difficult, necessary conversations about who gets represented in public space and how.",
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "The Art Association of Indianapolis. Sewall was a suffragist who believed culture was a vehicle for women's liberation and civic improvement. In 1883, she founded the Art Association (now Newfields) to bring culture to the \"prairie.\" Her activism was grounded in the belief that a city cannot be great without the refining influence of the arts, and that women should lead that charge. Influence & Existence: Her legacy exists as the Indianapolis Museum of Art (Newfields) and Herron School of Art + Design. While she has passed, the institutions she built remain the pillars of Indiana art.",
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "The Confederacy: Mississippi (1965) is one of Robert Indiana’s most politically charged works, part of a four-painting series titled The Confederacy (which also includes Alabama, Louisiana, and Florida). It features bold concentric circles (a \"bullseye\" motif) often rendered in stark colors like black, white, and yellow (or sometimes red/blue in print variations). Inside the innermost circle is a map of the state of Mississippi. A single star is placed on the map at the location of Philadelphia, Mississippi. This marks the site of the 1964 murders of civil rights workers James Chaney, Andrew Goodman, and Michael Schwerner (known as the Freedom Summer murders). Encircling the center is a provocative inscription that reads:\"Just as in the anatomy of man, every nation must have its hind part.\"\n\nThis work was a direct response to the violence Robert Indiana saw on the news during the Civil Rights Movement. By labeling Mississippi the \"hind part\" (a polite euphemism for the \"ass\" or \"rectum\") of the nation, Indiana was declaring the state—and its segregationist violence—as the shameful waste-center of the American body politic.\nThe target motif serves a double meaning: it visually draws the eye like a road sign, but also marks the state (and the specific city of Philadelphia) as a \"target\" of moral judgment and national scrutiny.\n\nThe work is related to the state of Indiana in three significant ways: The most direct connection is the artist himself. Born Robert Clark in New Castle, Indiana, he legally changed his last name to \"Indiana\" to honor his midwestern roots. He viewed himself as an \"American sign painter,\" and his work often reflected a Midwesterner's perspective on the wider United States.\n\nThis specific series created a stir in the artist's home state. When the Confederacy series was exhibited at the Indianapolis Museum of Art (now Newfields) in the 1970s, it reportedly caused some patrons to \"walk out in a huff\" and vow never to return. The blunt political messaging clashed with the more conservative sensibilities of the Indiana art public at the time, highlighting the tension between the artist's Hoosier roots and his radical political critiques. The Indianapolis Museum of Art (Newfields) holds one of the most significant collections of Robert Indiana's work in the world, maintaining a deep institutional tie between the artist's legacy and the state.",
      "medium": "Oil",
      "date": "May 1905",
  ...
  },
  {
    ...
    "artwork": {
      "title": "HOPE ",
      "description": "Created in 2008, this work was Robert Indiana’s direct response to the presidential campaign of Barack Obama. Indiana, who had famously created the LOVE image in the 1960s, came out of a quiet period in his career to repurpose his own iconic design for a new era. He replaced the letters L-O-V-E with H-O-P-E, keeping the signature stacked format and the tilted \"O\". He donated the copyright of the image entirely to the Obama campaign, allowing them to use it on T-shirts, posters, and pins to raise millions of dollars. Indiana famously stated that while LOVE was about a spiritual concept, HOPE was about a specific moment of political possibility.\nThis work functions as financial and iconic political activism. Unlike many artists who simply make \"protest art,\" Indiana used his art to generate actual capital for a cause. By donating the image rights, he turned his aesthetic style into a fundraising machine for the first African American president. The activism lies in the branding of optimism. He took the \"counter-culture\" font of the 1960s peace movement and successfully grafted it onto a 21st-century political platform, visually connecting the idealism of the past with the \"Change\" movement of the present. The image is historically permanent. Large-scale steel sculptures of HOPE (often painted in red, white, and blue) have been installed in cities like New York, Miami, and Munich. The \"HOPE\" poster became one of the defining visual symbols of the 2008 election (alongside Shepard Fairey’s work), proving that pop art could still sway national politics 40 years after its invention.",
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "This massive, two-panel work is deeply personal to Samuel Levi Jones, who was born and raised in Marion, Indiana. The title is a direct reference to the haunting lyrics of the song \"Strange Fruit\" (\"Black bodies swinging in the southern breeze, strange fruit hanging from the poplar trees\"). The song was famously inspired by the 1930 lynching of two teenagers, Thomas Shipp and Abram Smith, in Jones's hometown of Marion—the last confirmed classic lynching in the Northern United States. To create the piece, Jones \"skinned\" the covers off vintage law books and encyclopedias, ripping them apart to reveal the raw, uneven textures underneath. He then stitched these skins together into a grid. The use of law books is intentional: the victims of the Marion lynching were dragged out of a jail cell, denied due process, and murdered by a mob while the law stood by and did nothing. This work functions as institutional critique and anti-violence activism.\n\nBy physically destroying symbols of authority (law books), Jones acts out a protest against a legal system that has historically failed to protect Black citizens. He renders the books \"useless,\" just as the law was useless to Shipp and Smith. The process of stripping the covers is a violent metaphor for the violence inflicted on Black bodies. The finished surface of the artwork looks bruised, battered, and stitched back together, serving as an abstract memorial to the trauma that the town of Marion tried to bury. This specific work was acquired by the IU Eskenazi Museum of Art in Bloomington, Indiana, making it a permanent part of the state's cultural record. Its impact has extended beyond the museum walls; the themes explored in Poplar Trees laid the groundwork for Jones's recent collaboration on a proposed permanent memorial in Marion, titled \"Making a Garden of Strange Fruit,\" which aims to reclaim the site of the tragedy as a space for healing and reflection.",
  ...
  },
  {
    ...
    "artwork": {
      "title": "McDoel Blooms",
      "description": "Installed in June 2025, this large-scale street mural creates a vibrant floral carpet at the intersection of Allen and Fairview Streets in Bloomington’s historic McDoel Gardens neighborhood. Rachel Kavathe, an artist who is also a trained landscape architect, designed the piece to honor the neighborhood's specific architectural history. Since many McDoel homes were built in the 1920s and 30s, she stylized the flowers in an Art Deco aesthetic. The artwork features native plants found in local residents' yards—specifically Blue Flag Iris, Coreopsis, and Coneflower—visually proving why the neighborhood is named \"McDoel Gardens.\"\n\nThis work functions as ecological and communal placemaking activism. The creation of the mural was a collective act; it was painted during a \"Community Paint Day\" where neighbors claimed the street for themselves, turning a dangerous intersection for cars into a gathering space for people. By super-sizing these specific flowers on the pavement, Kavathe advocates for the protection of local pollinators. She makes the \"invisible\" ecosystem visible, reminding residents that their personal gardens are part of a critical environmental network. The artwork is currently in existence and active. Beyond just being beautiful, it serves a functional role as traffic calming art—signaling to drivers that they are entering a cared-for, residential zone where they must slow down. It stands as a fresh landmark for the neighborhood, reinforcing the identity of McDoel Gardens as a place where nature and community history intertwine.",
      "medium": "Street Mural",
      "date": "2025 (Upcoming)",
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "Operating out of rural Indiana, this husband-and-wife duo (Justin Roberts and Shannon Davis-Roberts) has revived the ancient craft of stick bending and weaving to create massive, whimsical sculptures. Their process is intensely physical and rooted in the land. They do not buy materials; they sustainably harvest wild willow and invasive species from local ditches and roadways. Their sculptures range from functional furniture (chairs and fences) to towering, surreal figures—such as \"The Connection,\" a massive woven head and hand reaching out to nature, or the \"Stick Man\" figures often seen at festivals. They twist the freshly cut wood while it is still pliable, creating organic forms that look like sketches come to life in 3D space. This work functions as environmental sustainability and \"slow art\" activism.\n\nTheir activism is in their supply chain. By using invasive species or wild-harvested willow, they are cleaning the local ecosystem while creating art. The sculptures are 100% biodegradable; eventually, they will rot and return to the earth, challenging the art world's obsession with permanence and plastic/metal waste. In a digital age, their work forces an interaction with the raw, imperfect texture of nature. It advocates for a lifestyle that is attuned to the seasons (harvesting in winter/spring) and respects the lifecycle of plants. Their work is currently in existence and highly active. You can find their permanent and semi-permanent installations at public venues like Conner Prairie, the Indianapolis Art Center, and various parks throughout the Midwest. They are also influential educators, frequently teaching \"willow bending\" workshops to ensure this traditional folk skill is not lost to history. Their brand \"Walk the Willow\" has become synonymous with the \"natural playground\" movement in Indiana.",
  ...
  },
  {
    ...
    "artwork": {
      ...
      "description": "Phyllis Boyd (with LaShawnda Crowe Storm)\nThe RECLAIM Project (Northwest Indianapolis).\nCo-founded by Phyllis Boyd (a landscape architect and artist) and LaShawnda Crowe Storm, this initiative was born from a desire to transform \"blight into beauty\" in the Riverside and Northwest Indianapolis neighborhoods. Funded by a major ArtPlace America grant, the project focused on revitalizing vacant lots and dangerous alleyways that children used as routes to school. Instead of just cleaning them up, Boyd and her team turned these neglected spaces into \"art parks\" and community assets. A signature element of the project was the installation of \"Art Sheds\"—utility sheds painted with vibrant murals that served as functional hubs for urban farming and community gatherings.\nThis project functions as restorative justice and design activism.\nEconomic & Social Restoration: The project explicitly hired formerly incarcerated residents to work on the landscaping and construction. By doing so, it used the act of \"reclaiming\" land as a parallel for \"reclaiming\" people, providing economic opportunity and dignity to neighbors who are often shut out of the workforce.\nSafety by Design: By clearing brush and adding art/beauty to dark alleys, the project used aesthetics to increase public safety, ensuring that children had safe, dignified paths to walk to school.\nThe project’s philosophy was highly influential and helped propel Phyllis Boyd into her current role as the Director of Indy Parks. While the specific grant-funded phase of RECLAIM has concluded, its physical footprint—such as the Rader Street Art Sheds and various pocket parks—remains in the neighborhood. More importantly, the project serves as a case study in Indianapolis for how \"creative placemaking\" can solve hard infrastructure problems (like safety and blight) while simultaneously building community wealth.",
